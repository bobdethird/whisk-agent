...
`scene.xml` is generated by `mujoco_sim/generate_apriltag_world.py`. Keep robot geometry in `so101.xml`, and change world objects such as tags, cameras, floor, or lighting through `mujoco_sim/apriltag_world_config.py`.
